...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (usernameFromSession == null) {
            ...
            //logged in user asked to logout
            ...
            //user is already logged in but asked to re-login again
            //forward request back to home page (index.jsp)
            getServletContext().getRequestDispatcher("chatroom.html").forward(request, response);
        }
    }
