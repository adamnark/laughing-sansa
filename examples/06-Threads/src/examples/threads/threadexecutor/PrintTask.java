...
class PrintTask implements Runnable {
    ...
    public PrintTask(String name) {
        ...
        sleepTime = 10000 + generator.nextInt(10000);
    ...
    public void run() {
        ...
        {
            System.out.printf(threadName + " going to sleep for " + sleepTime + " milliseconds.\n");
        ...
        // print thread name
        System.out.printf(threadName + " done sleeping\n");
    } // end method run
} // end class PrintTask<